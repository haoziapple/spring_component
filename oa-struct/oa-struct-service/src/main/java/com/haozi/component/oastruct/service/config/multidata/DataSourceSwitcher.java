package com.haozi.component.oastruct.service.config.multidata;
...
import com.haozi.component.oastruct.service.config.MyBatisConfig;

/**
 * @className:com.haozi.component.oastruct.service.config.multidata.DataSourceSwitcher
...
public class DataSourceSwitcher
{
	...
	// 数据源1切面配置
	@Pointcut(value = "execution(* com.haozi.component.oastruct.service.service.data1..*.*(..))")
	...
	// 数据源2切面配置
	@Pointcut(value = "execution(* com.haozi.component.oastruct.service.service.data2..*.*(..))")
	...
	// 数据源3切面配置
	@Pointcut(value = "execution(* com.haozi.component.oastruct.service.service.data3..*.*(..))")
