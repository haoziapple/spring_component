...
public class ProductsApiController implements ProductsApi {
    ...
    public ResponseEntity<List<Product>> productsPost( @NotNull @ApiParam(value = "Latitude component of location.", required = true) @RequestParam(value = "latitude", required = true) Double latitude,
