...
/**
 * @className:com.fzrj.starter.service.config.multidata.DataSourceSwitcher
...
public class DataSourceSwitcher
{
	...
	// 数据源1切面配置
	@Pointcut(value = "execution(* com.fzrj.starter.service.service.data1..*.*(..))")
	...
	// 数据源2切面配置
	@Pointcut(value = "execution(* com.fzrj.starter.service.service.data2..*.*(..))")
	...
	// 数据源3切面配置
	@Pointcut(value = "execution(* com.fzrj.starter.service.service.data3..*.*(..))")
