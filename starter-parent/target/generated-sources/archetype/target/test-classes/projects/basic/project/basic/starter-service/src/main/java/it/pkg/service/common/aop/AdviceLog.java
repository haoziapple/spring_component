...
import it.pkg.service.common.ParamException;
import it.pkg.service.common.util.HttpContextUtil;
import it.pkg.service.common.util.IPUtil;
...
public class AdviceLog
{
	...
	@Pointcut(value = "@annotation(it.pkg.service.common.aop.AddLog)")
