...
import ${package}.service.common.filter.RateLimitFilter;
import ${package}.service.common.filter.UserFilter;
import ${package}.service.common.util.SpringContextUtil;
...
/**
 * @className:${package}.service.config.FilterConfig
 * @description:自定义过滤器
 * @version:v1.0.0
    ...
    public FilterRegistrationBean filterRegistrationBean() {
        ...
        registrationBean.setFilter(new Filter() {
            ...
            public void init(FilterConfig filterConfig) throws ServletException {
                ...
                if (param != null)
                    this.passHosts = param.split("${symbol_escape}${symbol_escape}|");
